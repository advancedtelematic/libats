...
class DbHealthMetrics()(implicit db: Database, ec: ExecutionContext, scheduler: Scheduler) extends MetricsRepresentation {
...
class DbHealthCheck()(implicit db: Database, ec: ExecutionContext, scheduler: Scheduler) extends HealthCheck {
...
object DbHealthResource {
  def apply(versionRepr: Map[String, Any] = Map.empty,
            ...
            metricRegistry: MetricRegistry = MetricsSupport.metricRegistry)(implicit db: Database, ec: ExecutionContext, scheduler: Scheduler) = {
